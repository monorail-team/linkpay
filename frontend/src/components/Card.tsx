...
const Card: React.FC<CardModel> = ({ cardName, expiredAt, usedPoint, limitPrice ,cardColor}) => {
  ...
  return (
    <div className="relative w-full max-w-[354px] aspect-[354/210] rounded-xl shadow-md p-4 flex flex-col" style={backgroundStyle}>
      ...
      {/* 중앙: 설명 (Description) */}
      <div className="text-[25px] text-[#444] font-medium mb-6">
        {cardName}
      </div>

      {/* 하단: 사용금액 */}
      <div>
        <div className="text-sm text-[#555] mt-2">사용금액</div>
        <div className="text-2xl font-medium text-black text-center mt-1 ">
