...
public class TokenGenerator {
     ...
     * @생각[주빈] 토큰을 만드는 사람은 단순히 어떤 타입의, 어떤 값들을 포함하는 토큰을 만드는지에만 관심이 있다고 생각했습니다.
     * 따라서 범용성 있는 payload 필드를 사용해서 토큰에 포함될 값을 지정했습니다.
     ...
     * 외부에서 결정하면? 유지보수나 테스트하기 쉬워진다. 역할과 책임이 분명해진다.
