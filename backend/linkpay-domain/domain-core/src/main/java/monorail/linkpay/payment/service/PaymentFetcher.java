...
public class PaymentFetcher {
    ...
    public List<PaymentDto> fetchByWalletHistoryIdIn(Set<Long> walletHistoryIds) {
        return paymentRepository.findAllWithLinkCardByWalletHistoryIds(walletHistoryIds);
    }
}
